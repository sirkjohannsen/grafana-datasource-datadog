            ...
            _export('DataDogQueryCtrl', DataDogQueryCtrl = function (_QueryCtrl) {
              ...
              _createClass(DataDogQueryCtrl, [{
                ...
                value: function toggleEditorMode() {
                  ...
                  if (this.target.rawQuery) this.target.query = queryBuilder.buildQuery(this.target);
                }
              }, {
                ...
                value: function checkQuery() {
                  if (!(this.target.query || this.target.query.length != 0)) // to avoid 400 Bad Request, this is the default query
                ...
                value: function addFunction(funcDef) {
                  var func = dfunc.createFuncInstance(funcDef, {
